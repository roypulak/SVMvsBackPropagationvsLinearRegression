...
public class BPRingSeparable {
	...
	private static final int TRAINING_REPS = 1000000000;//10000000;//number of epoch
	...
	private static void inputDataProcess() {
		...
		try {
			br = new BufferedReader(new FileReader("E:/Algorithm Codes/BackPropagation/inputFiles/ring-separable.txt"));
	...
	private static void testNetwork() {	
		...
		try {
			...
			File file = new File("E:/Algorithm Codes/BackPropagation/outputFiles/ringsep_out.txt");
